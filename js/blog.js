window.onload = function () {
	...
	var soft_down=document.getElementsByName('soft_down');
	...
	for (var i=0;i<soft_down.length;i++) {
		soft_down[i].onclick = function () {
			centerWindow('soft_down.php?id='+this.title,'soft_down',250,400);
		};
	}
